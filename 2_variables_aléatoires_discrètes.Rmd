...
**ii.** Soit $x$ un réel. Les intervalles $\left]-\infty\,;\,x+\frac{1}{n}\right]$ forment une suite décroissante (par rapport à $n$) pour l'inclusion, donc d'après les axiomes des probabilités on a 
