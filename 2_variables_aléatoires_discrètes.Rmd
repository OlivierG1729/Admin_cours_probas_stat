...
\noindent Or, $\bigcap\limits_{n=1}^{\infty}\left]-\infty\,;\,x+\frac{1}{n}\right]=]-\infty ; x]$, donc le terme de gauche est égal à $\mathbb{P}(X\leq x)=F(x)$. Comme le membre de droite est égal à $\lim\limits_{n\to\infty}F\left(x+\frac{1}{n}\right)$, on a donc
