...
\noindent
**Conclusion. Au seuil de significativité $5\,\%$ on rejette donc l'hypothèse nulle, ce qui revient à dire qu'on conclut que la pièce est déséquilibrée.**

\noindent 
**Remarque.** Si on avait obtenu $4\,920$ fois pile sur nos $10\,000$ tirages, on aurait calculé $z_n=-1,6$ qui est dans la zone d'acceptation. On n'aurait donc pas rejeté l'hypothèse nulle, autrement dit on n'aurait pas rejeté l'hypothèse d'une pièce équilibrée.
:::
