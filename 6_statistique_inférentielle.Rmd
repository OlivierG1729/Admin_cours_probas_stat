...
\noindent Supposons que $X_n$ suive une loi normale :

$$X_n\sim\mathcal{N}(m,\sigma^2)$$

\noindent On considère deux problèmes différents

<center>**Problème 1 : estimation de $m$ lorsque $\sigma$ est connu**</center>

\noindent $m$ est l'espérance de $X_n$, on peut l'estimer par la moyenne empirique
