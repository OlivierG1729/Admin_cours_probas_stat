...
\noindent  Soit $\widehat{\theta}_n$ un estimateur sans biais de $\theta$ et admettant une variance $\sigma^2$. On peut donc appliquer l'inégalité de Bienaymé-Tchebychev :
